...
class StBoundary : public common::math::Polygon2d {
 public:
  ...
  std::vector<STPoint> upper_points() const { return upper_points_; }   // 上限
  std::vector<STPoint> lower_points() const { return lower_points_; }   // 下限
 ...
 private:
  BoundaryType boundary_type_ = BoundaryType::UNKNOWN;    // 不明障碍物
