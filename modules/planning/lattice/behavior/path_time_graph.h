...
// 更新横向边界
 ...
 private:
  std::pair<double, double> time_range_;                           // 时间范围
  std::pair<double, double> path_range_;                           // 路径范围
  const ReferenceLineInfo* ptr_reference_line_info_;               // ReferenceLineInfo
  std::array<double, 3> init_d_;                                   // 3维矩阵
                                                                   // 
