...
bool LateralQPOptimizer::optimize(
  ...
  ::qpOASES::HessianType hessian_type = ::qpOASES::HST_POSDEF;    // hessian矩阵
  ...
  // TODO(kechxu) move to gflags    // 优化器的参数
  ...
  int max_iter = 1000;   // 最多迭代1000次

  // Construct kernel matrix   构造核心矩阵
  ...
  // Construct offset vector   构造偏差向量
