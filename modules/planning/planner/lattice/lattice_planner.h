...
namespace apollo {
namespace planning {
// lattice是栅格的意思, LatticePlanner是planner的派生类的派生类
class LatticePlanner : public PlannerWithReferenceLine {     // 从带有参考线的planner继承而来
 public:
   ...
   * @return OK if planning succeeds; error otherwise.
   */
  common::Status PlanOnReferenceLine(    // planning是否成功, 会重写父类
